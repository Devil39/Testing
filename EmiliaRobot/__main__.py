...
import sys
import traceback
import EmiliaRobot.modules.sql.users_sql as sql
...
from EmiliaRobot.modules import ALL_MODULES
from EmiliaRobot.modules.helper_funcs.chat_status import is_user_admin
from EmiliaRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("EmiliaRobot.modules." + module_name)
...
def Emilia_about_callback(update, context):
    query = update.callback_query
...
**Telegram Library:** `v{peler}`""",
    ...
    about_callback_handler = CallbackQueryHandler(
        Emilia_about_callback, pattern=r"Emilia_", run_async=True
    )
